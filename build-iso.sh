...
export http_proxy=http://proxy.expert.de:8080
export https_proxy=http://proxy.expert.de:8080

B2D_URL="https://github.com/erSitzt/boot2docker/releases/download/v1.9.1/boot2docker.iso"
